...
public class HotelManagmentSystem extends JFrame implements ActionListener {
		...
		l1 = new JLabel("");
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/managment/system/icons/first"
                        + ".jpg"));
                Image i3 = i1.getImage().getScaledInstance(1366, 430,Image.SCALE_DEFAULT);
        ...
        public static void main(String[] args) {
                HotelManagmentSystem window = new HotelManagmentSystem();
